...
function showNotification(str,type)
{
   if(notificationType.indexOf(type)==-1)
   {
	   ...
	   playNotification();
	   typeString = "'"+type+"'";
	   $(notification).append( '<a href="img/button.jpg" data-lightbox="image-1" data-title="Actions"><div class="notebox" onClick="$("#answer").show();" ><img class="rebecca" src="./img/snupmsg.png" alt="dog">'+str+'</div></a><div id="answer" onClick="$(this).slideUp(500);removeNotification('+typeString+');">No</div>').children(':last').hide().fadeIn(800,"easeOutBack");
