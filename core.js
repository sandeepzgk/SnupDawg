...
function showNotification(str,type)
{
	   ...
	   playNotification();
	   typeString = "'"+type+"'";
	   $(notification).append( '<a href="img/button.jpg" data-lightbox="image-1" data-title="Actions"><div class="notebox" onClick="$(this).slideUp(500);removeNotification('+typeString+');" ><img class="rebecca" src="./img/snupmsg.png" alt="dog">'+str+'</div></a><div id="answer" onClick="$(this).hide();">HI</div>').children(':last').hide().fadeIn(800,"easeOutBack");
